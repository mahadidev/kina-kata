          ...
          >
            <div className="container flex flex-col lg:flex-row items-center justify-between">
              <div className="w-full max-w-[450px] flex justify-center flex-col mt-8 lg:mt-0">
                <div className="w-72 h-6 bg-gray-200 rounded-md mb-3" />
                <div className="w-full max-w-[400px]">
                  <div className="h-2 bg-slate-200 rounded-md w-[86%]"></div>
                  <div className="h-2 bg-slate-200 rounded-md w-[100%] mt-2"></div>
                  <div className="h-2 bg-slate-200 rounded-md w-[50%] mt-2"></div>
                  <div className="w-28 h-10 bg-slate-200 rounded-md mt-3" />
                </div>
              </div>
          ...
          <>
            <div className="container h-[500px]  flex items-center">
              <div className="w-full h-auto sm:h-[276px] bg-white drop-shadow-2xl rounded-xl py-8 px-8 flex flex-col justify-center">
                <div className="w-full max-w-[250px] h-4 bg-slate-200 rounded-md" />
                  ...
                  <div className="w-full flex">
                    ...
                    <div className="w-full ml-3 flex flex-col justify-center">
                      ...
                      <div className="w-full">
                        ...
                        <div className="w-[80%] h-2 bg-slate-200 mt-1" />
                        <div className="w-full h-2 bg-slate-200 mt-1" />
                      </div>
                    </div>
                  </div>
                  <div className="w-full flex">
